...
CFILES = main.c parse.c include_file.c stack.c printf.c definitions.c pass_1.c pass_2.c pass_3.c pass_4.c tree_node.c symbol_table.c il.c tac.c
HFILES = main.h parse.h include_file.h stack.h printf.h definitions.h pass_1.h pass_2.h pass_3.h pass_4.h tree_node.h symbol_table.h il.h tac.h
OFILES = main.o parse.o include_file.o stack.o printf.o definitions.o pass_1.o pass_2.o pass_3.o pass_4.o tree_node.o symbol_table.o il.o tac.o
