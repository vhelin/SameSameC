  ...
  .SECTION "main" FREE
    ...
    main:
      ...
      LD  D,H
      LD  E,L
      JP  initialize_adder__static_____test2_blb_659809113
    _return_1:
      ; new stack frame -> IX
      LD  IX,0
      ADD IX,DE
  ...
  .SECTION "initialize_adder__static_____test2_blb_659809113" FREE
    ; =================================================================
    ; ../test2.blb:37: static void initialize_adder(s8 *adder) {
    ; =================================================================
    initialize_adder__static_____test2_blb_659809113:
      ; A  - tmp
      ; BC - tmp
      ; DE - frame pointer
      ; HL - tmp
