  ...
  .SECTION "main" FREE
    ...
    _label_1:
      ; =================================================================
      ; ../test2.blb:14: __z80_out[0xBF] = 0x00;
      ; =================================================================
      ; -----------------------------------------------------------------
      ...
      OUT ($BF),A
      ; =================================================================
      ; ../test2.blb:15: __z80_out[0xBF] = 0xC0;
      ; =================================================================
      ; -----------------------------------------------------------------
    ...
    _label_7:
      ...
      JP  Z,_label_5
      ; =================================================================
      ; ../test2.blb:17: __z80_out[0xBE] = g_color;
      ; =================================================================
      ; -----------------------------------------------------------------
      ; TAC: __z80_out.uint8 (uint8)[190.uint8 (uint8)] := g_color.uint16 (uint16)
      ; -----------------------------------------------------------------
      LD  IX,g_color
      LD  A,(IX+0)
      OUT ($BE),A
    ...
    _label_5:
      ; =================================================================
      ; ../test2.blb:19: g_color--;
      ; =================================================================
      ; -----------------------------------------------------------------
      ; TAC: g_color.uint16 (uint16) := g_color.uint16 (uint16) - 1.uint8 (uint16)
      ; -----------------------------------------------------------------
      LD  IX,g_color
      LD  L,(IX+0)
      LD  H,(IX+1)
