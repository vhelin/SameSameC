  ...
  .SECTION "main" FREE
    ...
    main:
      ...
      ; -----------------------------------------------------------------
      ; =================================================================
      ; ../test2.blb:28: initialize_adder(&g_adder);
      ; =================================================================
      ; -----------------------------------------------------------------
      ...
      LD  D,H
      LD  E,L
      JP  initialize_adder__static_____test2_blb_2020986350
    _return_1:
      ; new stack frame -> IX
      LD  IX,0
      ADD IX,DE
    ...
    _label_1:
      ; =================================================================
      ; ../test2.blb:31: __z80_out[0xBF] = 0x00;
      ; =================================================================
      ; -----------------------------------------------------------------
      ...
      OUT ($BF),A
      ; =================================================================
      ; ../test2.blb:32: __z80_out[0xBF] = 0xC0;
      ; =================================================================
      ; -----------------------------------------------------------------
      ...
      OUT ($BF),A
      ; =================================================================
      ; ../test2.blb:34: for (i = 0; i < sizeof(array); i++)
      ; =================================================================
      ; -----------------------------------------------------------------
    ...
    _label_11:
      ...
      JP  Z,_label_9
      ; =================================================================
      ; ../test2.blb:36: __z80_out[0xBE] = color;
      ; =================================================================
      ; -----------------------------------------------------------------
    ...
    _label_5:
      ; =================================================================
      ; ../test2.blb:38: add_to_color(&color, g_adder);
      ; =================================================================
      ; -----------------------------------------------------------------
  ...
  .SECTION "initialize_adder__static_____test2_blb_2020986350" FREE
    ; =================================================================
    ; ../test2.blb:43: static void initialize_adder(s8 *adder) {
    ; =================================================================
    initialize_adder__static_____test2_blb_2020986350:
      ; A  - tmp
      ; BC - tmp
      ; DE - frame pointer
      ; HL - tmp
