  ...
  .SECTION "add_1" FREE
    ...
    add_1:
      ...
      ; -----------------------------------------------------------------
      ; =================================================================
      ; ../test2.blb:20: color[0] = color[0] + 1;
      ; =================================================================
      ; -----------------------------------------------------------------
      ; TAC: r0.uint8 (uint8) := 0.uint8 (uint8)
      ; -----------------------------------------------------------------
      ...
      LD  (IX+0),0
      ; -----------------------------------------------------------------
      ; TAC: r1.uint16 (uint16) := color.uint16 (uint16)[0.uint8 (uint8)]
      ; -----------------------------------------------------------------
      ; offset -5
      LD  IY,-5
      ADD IY,DE
      ...
      LD  (IX+1),H
      ; -----------------------------------------------------------------
      ; TAC: r2.uint16 (uint16) := r1.uint16 (uint16) + 1.uint8 (uint16)
      ; -----------------------------------------------------------------
      ; offset -8
      LD  IX,-8
      ADD IX,DE
      ...
      LD  (IX+1),H
      ; -----------------------------------------------------------------
      ; TAC: color.uint16 (uint16)[r0.uint8 (uint8)] := r2.uint16 (uint16)
      ; -----------------------------------------------------------------
      ; offset -10
      LD  IX,-10
      ADD IX,DE
